...
<body onload="admin();">
    <nav class="navbar navbar-expand-sm navbar-dark sticky-top" style="background-color: black;">
        ...
        <div class="collapse navbar-collapse" id="navbarMenu">
            <ul class="navbar-nav Font">
                <li class="nav-item"><a href="#accountsManagment" class="nav-link">Accounts Managment</a></li>
                <li class="nav-item"><a href="#addAccount" class="nav-link">Accounts +</a></li>
                <li class="nav-item"><a href="#accountSettings" class="nav-link">Settings</a></li>
    ...
    <section id="accountsManagment" class="section">


        <div id="adminExcited" class="container">
            <div class="row row-md">

                <h1 class="adminH pt-3">Manage Adminstrator Accounts:</h1>
            </div>

            <div class="row row-md">
                <div class="col adminHeader">
                    Name
                </div>
                <div class="col adminHeader">
                    Contact Info.
        ...
        <div id="noadminExcited" class="container">



            <label>
                No Adminstrator Accounts Yet <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bag-x" viewBox="0 0 16 16">
    ...
    <section id="addAccount" class="section">
        <form action="mainAdminPage.php#addAccount" method="POST">
            <section class="Form">
                <div class="row">
                            ...
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <?php if (isset($_GET['firstname'])) { ?>
                                        <input name="firstname" class="form-control textField" value="<?php echo $_GET['firstname']; ?>" type="text" maxlength="10" pattern=".{3,}" required>
                                    <?php } else { ?>
                                        <input name="firstname" class="form-control textField" type="text" maxlength="10" pattern=".{3,}" required>
                                    <?php } ?>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <?php if (isset($_GET['lastname'])) { ?>
                                        <input name="lastname" class="form-control textField" value="<?php echo $_GET['lastname']; ?>" type="text" maxlength="10" pattern=".{3,}" required>
                                    <?php } else { ?>
                                        <input name="lastname" class="form-control textField" type="text" maxlength="10" pattern=".{3,}" required>
                                    <?php } ?>
                            ...
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <?php if (isset($_GET['phonenumber'])) { ?>
                                        <input name="phonenumber" class="form-control textField" value="<?php echo $_GET['phonenumber']; ?>" type="text" maxlength="13" pattern=".{3,}" required>
                                    <?php } else { ?>
                                        <input name="phonenumber" class="form-control textField" type="text" maxlength="13" pattern=".{3,}" required>
                                    <?php } ?>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <?php if (isset($_GET['email'])) { ?>
                                        <input name="emailaddress" class="form-control textField" value="<?php echo $_GET['email']; ?>" type="text" maxlength="40" pattern=".{3,}" required>
                                    <?php } else { ?>
                                        <input name="emailaddress" class="form-control textField" type="text" maxlength="40" pattern=".{3,}" required>
                                    <?php } ?>
                                </div>
                            </div>
                            <div class="form-row pb-3">
                                <div class="col">
                                    <p class="defaultFont">Positon</p>
                        ...
                        <div id="registerContainer2" class="container px-4 py-3 mt-5 border" style=" min-width: 350px;">
                            ...
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <?php if (isset($_GET['username'])) { ?>
                                        <input name="username" class="form-control textField" value="<?php echo $_GET['username']; ?>" type="text" maxlength="10" pattern=".{3,}" required>
                                    <?php } else { ?>
                            ...
                            <div class="form-row">
                                <div class="col pt-lg-4 justify-content-end">
                                    <button type="submit" class="btn btn-primary custom-btn blueB" name="reg_admin">Add Account</button>
                                </div>
                            ...
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    if (isset($_GET['change'])) {
                                        echo "<p id='x' style='padding-top: 5px;' onmouseover='clearError(this.id)' class='success'>";
                                        if ($_GET['change'] == "accountAdded") {
                                            echo "Account is added successfully.</br>";
                                        }
                                        echo "</p>";
                                    }
                                    if (isset($_GET['passwordError'])) {

                                        echo "<p id='y' onmouseover='clearError(this.id)' style='padding-top: 5px;' class='error'>";

                                        if ($_GET['passwordError'] == 1) {
                                            echo "Password do not much.</br>";
                                        };
    ...
    <section id="accountSettings" class="section">
        ...
        <form action="mainAdminpage.php#accountSettings" method="POST">
            <section class="Form">
                <div class="row">
                    <div class="col-lg-4 ">
                    ...
                    <div class="modal fade " id="changepasswordModal">
                        <div class="modal-dialog  ">
                            <div class="modal-content border border-primary">
                                ...
                                <div class="modal-footer">
                                    <button name="changePassAdmin" class="btn btn-primary custom-btn blueB" type="submit">Change Password</button>
                                </div>
                ...
                <div class="modal fade " id="areUsure">
                    <div class="modal-dialog  ">
                        <div class="modal-content border border-primary">
                            ...
                            <div class="modal-footer">
                                <button id="confirmDelete" class="btn btn-primary">Confirm</button>
                            </div>
                        </div>
            ...
            <div class="col">
                <div class="modal fade " id="position">
                    <div class="modal-dialog  ">
                        <div class="modal-content border border-primary">
                            <div class="modal-header">
                                <h5>Change admin position:</h5>
                            </div>


                            <div id="checkBoxes" class="modal-body">
                                <label class="radio-inline"><input type="radio" name="option" value="Supervisor" checked> Supervisor</label>
                                <label class="radio-inline"><input type="radio" name="option" value="Subadmin"> Subadmin</label>
                                <label class="radio-inline"><input type="radio" name="option" value="Delivery"> Delivery</label>
                                <label class="radio-inline"><input type="radio" name="option" value="Manufacture"> Manufacture</label>
                            </div>
                            <div class="modal-footer">
                                <button id="changePosition" class="btn btn-primary">Confirm</button>
                            </div>
