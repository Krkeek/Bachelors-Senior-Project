...
<body onload="pendingOrders()">
    <nav class="navbar navbar-expand-sm navbar-dark sticky-top" style="background-color: black;">
        ...
        <div class="collapse navbar-collapse" id="navbarMenu">
            <ul class="navbar-nav Font">
                <li class="nav-item"><a href="#pendingOrders" class="nav-link">Pending Orders</a></li>
    ...
    <section id="pendingOrders" class="section">


        <div id="pendingOrdersExcited" class="container">
            <div class="row row-md">

                <h1 class="adminH pt-3">Orders waiting for approval:</h1>
                <div id="Count"></div>
            </div>
        ...
        <div id="nopendingOrdersExcited" class="container">



            <label>
                No Pending Orders <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bag-x" viewBox="0 0 16 16">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col">
                <div class="modal fade " id="orderApproved">
                    <div class="modal-dialog  ">
                        <div class="modal-content border border-primary">
                            <div class="modal-header center">
                                <h5>Order <span style="color: #3366ff;">Approved</span></h5>
                            </div>
                        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col">
                <div class="modal fade " id="orderRejected">
                    <div class="modal-dialog  ">
                        <div class="modal-content border border-primary">
                            <div class="modal-header center">
                                <h5>Order <span style="color:red;">Rejected</span></h5>
                            </div>
                        </div>
                ...
                <div class="modal fade" id="showMyOrder">
                    <div id="myCart" class="modal-dialog modal-lg " style="border-color: black;">
                        <div id="myCart2" class="modal-content border border-primary">
                            ...
                            <div id="showDrop2" class="modal-body cartContent">
